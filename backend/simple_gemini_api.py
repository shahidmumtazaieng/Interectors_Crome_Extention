"""
Simple Gemini API Server for Interectors Chrome Extension
This is a standalone Flask API server that directly uses Google's Gemini API.
"""
...
# Function to summarize text using Gemini directly
...
# Function to answer questions using Gemini directly
def answer_question(text: str, question: str) -> str:
    """Answer a question based on the provided text using Gemini"""
    try:
